export namespace app {
	...
	export class CodexSnapshot {
	    ...
	    static createFrom(source: any = {}) {
	        return new CodexSnapshot(source);
	    }
	...
	export class ComponentSnapshot {
	    ...
	    static createFrom(source: any = {}) {
	        return new ComponentSnapshot(source);
	    }
	...
	export class SlackConfigSnapshot {
	    ...
	    static createFrom(source: any = {}) {
	        return new SlackConfigSnapshot(source);
	    }
	...
	export class ConfigureSlackCommand {
	    ...
	    static createFrom(source: any = {}) {
	        return new ConfigureSlackCommand(source);
	    }
	...
	export class RuntimeLogSnapshot {
	    ...
	    static createFrom(source: any = {}) {
	        return new RuntimeLogSnapshot(source);
	    }
	...
	export class ExecutionEventSnapshot {
	    ...
	    static createFrom(source: any = {}) {
	        return new ExecutionEventSnapshot(source);
	    }
	...
	export class ProcessFailureSnapshot {
	    code: string;
	    message: string;

	    static createFrom(source: any = {}) {
	        return new ProcessFailureSnapshot(source);
	    }
	...
	export class ProcessSnapshot {
	    ...
	    latest_output_at: number;
	    error?: ProcessFailureSnapshot;
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.expected_commit = source["expected_commit"];
	        this.working_directory = source["working_directory"];
	        this.started_at = source["started_at"];
	        this.updated_at = source["updated_at"];
	        this.exit_code = source["exit_code"];
	        this.stdout_tail = source["stdout_tail"];
	        this.stderr_tail = source["stderr_tail"];
	        this.latest_stream = source["latest_stream"];
	        this.latest_output_at = source["latest_output_at"];
	        this.error = this.convertValues(source["error"], ProcessFailureSnapshot);
	    }
	...
	export class SlackSnapshot {
	    ...
	    static createFrom(source: any = {}) {
	        return new SlackSnapshot(source);
	    }
	...
	export class DesktopSnapshot {
	    ...
	    latest_execution?: ExecutionEventSnapshot;
	    latest_runtime_error?: RuntimeLogSnapshot;
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.processes = this.convertValues(source["processes"], ProcessSnapshot);
	        this.latest_execution = this.convertValues(source["latest_execution"], ExecutionEventSnapshot);
	        this.latest_runtime_error = this.convertValues(source["latest_runtime_error"], RuntimeLogSnapshot);
	...
	export class MCPRequestSnapshot {
	    ...
	    static createFrom(source: any = {}) {
	        return new MCPRequestSnapshot(source);
	    }
	...
	export class SlackMessageSnapshot {
	    ...
	    static createFrom(source: any = {}) {
	        return new SlackMessageSnapshot(source);
	    }
